...
<?php if(!ReqAjax()) require BASE_DIR.'/inc/header.php'; ?>
  ...
  <section class="bg-white py-[2.1875rem]">
    ...
    <div class="container mt-[3.0625rem]">
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-3 gap-4 lg:grid-cols-4 xl:grid-cols-5 lg:gap-[1.0625rem] pb-[1.8125rem] pt-5 border-b border-b-deep-gray-border">
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/SP-110-Sagim-Pencesi-Komple.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
        ...
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/pulsaotor-60-40.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
        ...
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/13-litre-sut-kovasi.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
        ...
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/Mod._326_Nuckel_db697b4001.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
        ...
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/inek-yatagi-KEWPlus-katman-3.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
  ...
  <section class="bg-white pb-[2.1875rem]">
    <div class="container">
      ...
      <div
        ...
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/kurtsan-stainles-Milk-Churun-30-lt.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
        ...
        <div class="card-wrapper">
          <div class="card-media">
            <img src="public/img/Emaye-suluk-Mod.-375-VA.jpg" class="card-image" alt="Easy Cleaner Brush">
          </div>
