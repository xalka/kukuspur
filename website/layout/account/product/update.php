                ...
                <div class="mt-2 text-start">
                    <div class="min-h-screen bg-gray-100 mt-6 font-sans">
                        ...
                        <div class="bg-white rounded-xl px-4 pb-6 shadow-md">
                            ...
                            <form method="POST" action="/account?view=product&action=update&id=<?=$data['product']['detail']['productId']?>" enctype="multipart/form-data" class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="product" value="<?=$data['product']['detail']['product']?>" placeholder="Product name" class="mt-1 input-control"/>
                                        </div>
                                        
                                        <div>
                                            <label>Description <span class="text-red">*</span></label>
                                            <textarea rows="4" class="input-control" name="descrp"><?=$data['product']['detail']['descrp']?></textarea>
                                        ...
                                        <div>
                                            ...
                                            <!-- Current Images -->
                                            <div class="mt-4 grid grid-cols-4 gap-2 preview-images">
                                            <?php foreach ($data['product']['images'] as $img) { ?>
                                                <div class="relative">
                                                    <img src="/public/img/uploads/<?=$img['img']?>" class="h-24 w-full object-cover rounded-md border">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            <div>
                                                ...
                                                <input type="text" name="price" placeholder="Price" class="mt-1 input-control" value="<?=$data['product']['detail']['price']?>">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1 relative rounded-md shadow-sm">
                                                    <div class="relative group">
                                                        <input type="text" class="input-control" name="discount" placeholder="Discount" value="<?=$data['product']['detail']['discount']?>">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1 relative rounded-md shadow-sm">
                                                    <div class="relative group">
                                                        <input type="text" class="input-control" name="tax" placeholder="Tax" value="<?=$data['product']['detail']['tax']?>">
                                                        <div class="absolute inset-y-0 right-3 flex items-center">%</div>
                                                    </div>                                
                                                </div>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="stock" placeholder="Stock Quality" class="mt-1 input-control" value="<?=$data['product']['detail']['stock']?>">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    <select name="statusId" class="input-control">
                                                        <option <?php if($data['product']['detail']['isActive'] == 1){ ?> selected <?php } ?> value="1">Active</option>
                                                        <option <?php if($data['product']['detail']['isActive'] == 0){ ?> selected <?php } ?> value="0">In-active</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="sku" class="mt-1 input-control" value="<?=$data['product']['detail']['sku']?>">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-1">
                                                    ...
                                                    <?php foreach ($data['categories'] as $category) { ?>
                                                        <option <?php if($category['categoryId'] == $data['product']['detail']['categoryId']){ ?> selected <?php } ?> value="<?=$category['categoryId']?>"><?=$category['category']?></option>
                                                    <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="pt-4 border-t border-light-gray-border">
                                            ...
                                            <div class="mt-2 space-y-2">
                                                <div>
                                                    ...
                                                    <textarea rows="4" name="seo_title" class="input-control mt-1"><?=$data['product']['detail']['seo_title']?></textarea>
                                                </div>
                                                <div>
                                                    <label class="block text-sm text-gray-700">Meta Description</label>
                                                    <textarea rows="4" name="meta_descrp" class="input-control mt-1"><?=$data['product']['detail']['meta_descrp']?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
